...
export const DelegationChangeProposal: React.FC<Props> = ({ open, handleClose, defaultValues }) => {
    ...
    <FormProvider {...methods}>
      <ResponsiveDialog
        ...
        <Content container direction={"column"} style={{ gap: 18 }}>
          <Grid item>
            <ProposalFormInput label={"New address"}>
              <Controller
          ...
          <SendButton
            ...
            disabled={!dao || !daoHoldings || !newDelegationAddress || newDelegationAddress === ""}>
            Submit
          </SendButton>
        </Content>
      </ResponsiveDialog>
