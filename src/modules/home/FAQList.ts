export const FAQ_LIST = [
  {
    ...
    \n &nbsp;
    \n [Crypto's networked decentralization will drive web3](https://techcrunch.com/2021/09/16/cryptos-networked-collaboration-will-drive-web-3-0/), *Tech Crunch*.
    \n[Why Web3 Matters](https://future.a16z.com/why-web3-matters/), *a16z*.
    \n[Why web 3.0 communities are a big deal?](https://uxdesign.cc/why-web-3-0-communities-are-a-big-deal-600c8e5013c3): a non-technical narrative, *UX Collective*.
    \n &nbsp;
    \n &nbsp;
  ...
  {
    question: "How much does launching a DAO on Tezos cost?",
    answer: `About 7 tez.`,
  },
];
