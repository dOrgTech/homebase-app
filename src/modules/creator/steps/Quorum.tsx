    ...
    <>
      ...
      <Grid container direction="row" alignItems="center" style={{ marginTop: 14 }}>
        <AdditionContainer item xs={12} sm={4}>
          <ItemContainer container direction="row" alignItems="center" justify="center">
            <GridItemCenter item xs={3}>
              <Field name="minQuorumAmount" type="number" placeholder="00" component={TextField}></Field>
            </GridItemCenter>
        ...
        <AdditionContainer item xs={12} sm={4}>
          <ItemContainer container direction="row" alignItems="center" justify="center">
            <GridItemCenter item xs={3}>
              <Field name="maxQuorumAmount" type="number" placeholder="00" component={TextField}></Field>
            </GridItemCenter>
            <GridItemCenter item xs={7} container direction="row" justify="space-around">
      ...
      <Grid container direction="row">
        <Grid item xs={12}>
          <CustomTypography variant="subtitle1" color="textSecondary">
            Each period, a new quorum threshold is calculated based on the previous&#39;s period participation. It is
            set as a percentage of the governance token&#39;s total supply
          </CustomTypography>
        </Grid>
      </Grid>
