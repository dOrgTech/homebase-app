...
import { LambdaAddArgs, LambdaExecuteArgs, RegistryProposeArgs } from "../registryDAO/types"
...
export const useLambdaExecutePropose = () => {
  ...
  return useMutation<TransactionWalletOperation | Error, Error, { dao: LambdaDAO; args: LambdaExecuteArgs }>(
    async ({ dao, args }) => {
