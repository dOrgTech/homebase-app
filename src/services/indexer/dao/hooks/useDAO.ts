        ...
        extra:
          dao.dao_type.name === "registry"
            ? ({
                ...
                frozen_extra_value: unpackExtraNumValue((dao.registry_extras[0] as any).frozen_extra_value),
            ...
            : ({
                ...
                frozen_extra_value: unpackExtraNumValue((dao.treasury_extras[0] as any).frozen_extra_value),
